...
async function triggerOverDueInvoiceNotification(subscriberId, client_name, invoice_number, invoice_date, business_company_email, business_company_name) {
    novu.trigger(process.env.OVERDUE_INVOICE, {
        to: {
            subscriberId: subscriberId
        },
        payload: {
    ...
    console.log("Overdue Invoice sent to client email address");
}
// console.log("novu_api_key: ", process.env.NOTIFICATION_WORKFLOW)
// console.log("novu_api_key: ", process.env.OVERDUE_INVOICE)
...
module.exports = {
    ...
    triggerOverDueInvoiceNotification
}